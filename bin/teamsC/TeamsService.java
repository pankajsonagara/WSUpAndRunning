 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://ts.chap1.ypd.com/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://ts.chap1.ypd.com/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://ts.chap1.ypd.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ts.chap1.ypd.com/", "TeamsPort"), Teams.class, features);
    }
