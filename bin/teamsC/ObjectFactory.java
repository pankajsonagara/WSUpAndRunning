...
public class ObjectFactory {
    ...
    private final static QName _GetTeams_QNAME = new QName("http://ts.chap1.ypd.com/", "getTeams");
    private final static QName _GetTeam_QNAME = new QName("http://ts.chap1.ypd.com/", "getTeam");
    private final static QName _GetTeamResponse_QNAME = new QName("http://ts.chap1.ypd.com/", "getTeamResponse");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://ts.chap1.ypd.com/", "getTeamsResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.chap1.ypd.com/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.chap1.ypd.com/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.chap1.ypd.com/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ts.chap1.ypd.com/", name = "getTeamsResponse")
